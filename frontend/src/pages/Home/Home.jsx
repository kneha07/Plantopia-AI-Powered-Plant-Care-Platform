      ...
      <section className="section features">
        <div className="container">
          ...
          <div className="features-grid">
            ...
            <div className="feature-item" style={{ cursor: 'pointer' }} onClick={() => onNavigate('chat')}>
              <span className="feature-icon" aria-hidden="true">🤖</span>
              <h3 className="feature-title">Flora AI Expert</h3>
              <p className="feature-description">
                Chat with our AI plant expert for personalized care advice, diagnosis, and recommendations.
              </p>
            </div>
            <div className="feature-item" style={{ cursor: 'pointer' }} onClick={() => onNavigate('ar')}>
              <span className="feature-icon" aria-hidden="true">📱</span>
              <h3 className="feature-title">AR Visualization</h3>
              <p className="feature-description">
                See how plants look in your space using augmented reality before you buy.
              </p>
            </div>
            <div className="feature-item" style={{ cursor: 'pointer' }} onClick={() => onNavigate('my-plants')}>
              <span className="feature-icon" aria-hidden="true">💧</span>
              <h3 className="feature-title">Watering Tracker</h3>
              <p className="feature-description">
                Track your plant collection and never miss a watering with smart reminders.
              </p>
            </div>
            <div className="feature-item">
              <span className="feature-icon" aria-hidden="true">🔍</span>
