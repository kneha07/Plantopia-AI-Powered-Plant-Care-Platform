...
function Navigation({ currentPage, onNavigate }) {
  ...
  const mainNavItems = [
    ...
    { id: 'my-plants', label: 'My Plants', hash: '#/my-plants' },
  ];

  const submenuItems = [
    { id: 'finder', label: 'Plant Finder', hash: '#/finder' },
    { id: 'chat', label: 'Flora AI Chat', hash: '#/chat' },
    { id: 'ai', label: 'AI Plant Tools', hash: '#/ai' },
    { id: 'ar', label: 'AR View', hash: '#/ar' },
  ...
  const isResourcesActive = ['finder', 'about', 'chat', 'ai', 'ar'].includes(currentPage);
